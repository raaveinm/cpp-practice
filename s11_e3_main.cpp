...
public:
    ...
    [[nodiscard]] virtual double GetArea() const { return area_; }
    [[nodiscard]] virtual string GetType() const { return type_; }
...
public:
    Rectangle(const double width, const double height, const Color color)
    ...
    [[nodiscard]] double GetArea() const override { return width_ * height_; }
    [[nodiscard]] string GetType() const override { return "Rectangle"s; }
...
public:
    ...
    [[nodiscard]] double GetArea() const override { return M_PI * radius_ * radius_; }
    [[nodiscard]] string GetType() const override { return "Circle"s; }
